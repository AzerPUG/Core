...
function addonMain:CreateOptionsPanels()
    ...
    OptionsCoreTitle:SetSize(OptionsCorePanel:GetWidth(), 30)
    ...
    local ReloadCheckBox = CreateFrame("CheckButton", "ReloadCheckBox", ReloadFrame, "ChatConfigCheckButtonTemplate")
