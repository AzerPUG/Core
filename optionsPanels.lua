...
function AZP.OptionsPanels:Generic(panelName, panelContent)
	...
	OptionsPromoPanels = CreateFrame("Frame", nil, optionFrame)
	...
	local panelTitle = "AzerPUG's " .. panelName
	...
	if type(panelContent) == "string" then
		...
		optionFrame.placeholder:SetPoint("TOP", 0, -150)
		...
		panelTitle = "\124cFFFF0000" .. panelTitle .. " not installed/loaded!\124r"
	elseif type(panelContent) == "function" then
		optionFrame.subFrame = CreateFrame("FRAME", nil, optionFrame)
		optionFrame.subFrame:SetSize(optionFrame:GetWidth(), 500)
		optionFrame.subFrame:SetPoint("TOP", 0, -150)
		panelContent(optionFrame.subFrame)
		optionFrame.subFrame:Show()
		panelTitle = "\124cFF00FFFF" .. panelTitle .. "\124r"
	end
